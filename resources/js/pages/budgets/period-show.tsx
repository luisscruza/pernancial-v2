...
import { ArrowLeft, Calendar, Copy, Edit, Plus, TrendingUp, TrendingDown, DollarSign, Eye } from 'lucide-react'
import type { BudgetPeriod, BudgetSummary, Category, SharedData, Currency } from '@/types/index'
                ...
                <div className="space-y-4 p-4 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-lg font-bold text-red-600">{formatCurrency(totalExpenseSpent, auth.user.currency)}</div>
                    </div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-xs text-muted-foreground">
                      {isExpenseOverBudget ? 'Sobregirado' : 'Disponible'}
                    </div>
                ...
                <div className="space-y-4 p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-lg font-bold text-green-600">{formatCurrency(totalIncomeReceived, auth.user.currency)}</div>
                    </div>
                  </div>
                  <div className="space-y-1">
                    <div className="text-xs text-muted-foreground">
                      {isIncomeOverBudget ? 'Ingreso extra 🎉' : 'Pendiente'}
                    </div>
            ...
            <div className="space-y-8">
              ...
              {expenseBudgets.length > 0 && (
                ...
                >
                  ...
                  <div className="overflow-hidden shadow ring-1 ring-gray-200 ring-opacity-5 rounded-lg bg-white">
              ...
              {incomeBudgets.length > 0 && (
                ...
                >
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Ingresos</h3>
                  <div className="overflow-hidden shadow ring-1 ring-gray-200 ring-opacity-5 rounded-lg bg-white">
                    <table className="min-w-full divide-y divide-gray-300">
                      <thead className="bg-gray-50">
                        <tr>
