...
export default function AccountPage({
    ...
    const groupedAccounts = useMemo(() => {
        ...
        filteredAccounts.forEach((account) => {
            const type = account.type_label || 'general';
            if (!groups[type]) {
                groups[type] = [];
            }
            ...
            <div className="ml-8 w-full max-w-7xl p-4">
                ...
                >
                    ...
                    <div className="rounded-xl border border-gray-50 bg-white p-4">
                        <p className="mb-1 text-xs text-gray-500">Balance en cuenta</p>
                    ...
                    <AnimatePresence mode="popLayout">
                        ...
                        >
                            <Button
                                variant="default"
                                asChild
                                className="bg-accent text-accent-foreground hover:bg-accent/80 w-full rounded-full py-6 transition-all duration-200"
                            >
