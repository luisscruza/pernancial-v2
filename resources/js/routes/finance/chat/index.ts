...
* @see app/Http/Controllers/FinanceChatController.php:169
...
* @see app/Http/Controllers/FinanceChatController.php:176
...
* @see app/Http/Controllers/FinanceChatController.php:201
* @route '/finance/chat/{conversation}'
*/
