...
final class UpdateReceivableRequest extends FormRequest
{
    ...
    {
        return [
            'contact_id.required' => 'Selecciona la persona que te debe.',
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                if ($this->float('amount_total') < $receivable->amount_paid) {
                    $validator->errors()->add('amount_total', 'El monto no puede ser menor al monto ya cobrado.');
                }
            },
        ];
    }

    public function getDto(): UpdateReceivableDto
    {
        return new UpdateReceivableDto(
