...
final class StorePayablePaymentRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'account_id.required' => 'Selecciona la cuenta desde la que pagas.',
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                $remaining = $payable->amount_total - $payable->amount_paid;
    ...
    public function getDto(): CreatePayablePaymentDto
    {
        return new CreatePayablePaymentDto(
