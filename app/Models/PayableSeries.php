...
use Database\Factories\PayableSeriesFactory;
 ...
 */
final class PayableSeries extends Model
{
    /**
     * @use BelongsToUser<PayableSeries>
     */
    use BelongsToUser;

    /** @use HasFactory<PayableSeriesFactory> */
    use HasFactory;
    ...
    {
        return $this->hasMany(Payable::class, 'payable_series_id');
    }
